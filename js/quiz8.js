const quizData = [
  {
      question: "Qual animal é conhecido por ser o mais rápido do mundo?",
      choices: ["Leão", "Tartaruga", "Elefante", "Guepardo"],
      correct: "Guepardo"
  },
  {
      question: "Qual a maior ave que já existiu?",
      choices: ["Condor", "Ornitorrinco", "Avestruz", "Arara-azul"],
      correct: "Avestruz"
  },
  {
      question: "Qual mamífero marinho pode viver mais de 200 anos?",
      choices: ["Orca", "Golfinho", "Foca", "Baleia-azul"],
      correct: "Baleia-azul"
  },
  {
      question: "Qual o processo pelo qual os insetos se transformam de larva em adulto?",
      choices: ["Adaptação", "Mimetismo", "Mutação", "Metamorfose"],
      correct: "Metamorfose"
  },
  {
      question: "Em qual ambiente vivem os ursos polares?",
      choices: ["Savana", "Tundra", "Deserto", "Floresta tropical"],
      correct: "Tundra"
  }
];
...
function restartQuiz() {
  ...
  window.location.href = "../pages/quiz8.html";  
}
